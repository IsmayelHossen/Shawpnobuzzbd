      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class=""> <a title="Go to Home Page" href="shop_listm.php">men</a><span>&raquo;</span></li>
            <li><strong><a title="Go to Home Page" href="shop_listm.php?men=$brand"><?php echo$brand ?> </a></strong></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            ...
            <div class="toolbar">
              <div class="view-mode">
                <ul>
                  <li class="active"> <a href="shop_gridm.php"> <i class="fa fa-th-large"></i> </a> </li>
                  <li> <a href="shop_listm.php"> <i class="fa fa-th-list"></i> </a> </li>
                </ul>
              </div>
              <div class="sorter">
                <div class="short-by">
                  ...
                  <select name="select" id="select">
                    ...
                    <?php 
                      $query="SELECT DISTINCT brandn FROM allin WHERE categories='Men' AND brand='$brand'";
              ...
              <ul class="products-list" id="products-list">
                ...
                <?php 
                   ...
                   $select=$_POST['select'];
                     ...
                     if($select=='ASC'){
                    $query="SELECT*FROM allin WHERE categories='Men' AND brand='$brand' ORDER BY amount ASC  ";
                    $result=$db->select($query);
                  }
                  elseif($select=='DESC'){
                    $query="SELECT*FROM allin WHERE categories='Men' AND brand='$brand' ORDER BY amount DESC  ";
                           $result=$db->select($query);
                           
                  }
                  else{
                         $query="SELECT*FROM allin WHERE categories='Men' AND brand='$brand' AND brandn='$select' ";
                           $result=$db->select($query);
                  }
              ...
              <?php }else{?>
                 <?php 
                   if(!isset($_GET['page'])){
                    ...
                    $query="SELECT*FROM allin WHERE categories='Men' AND brand='$brand' LIMIT $start,12 ";
                    $result=$db->select($query);
                    if($result){
                       while($row=$result->fetch_assoc()){
            ...
            if($page>1){
              ...
              <li>  <a class="btn" href="?page=<?php echo$page-1 ?> & men= <?php echo$brand ?>">Previous</a></li>
               <?php }?>

               <?php 
                  $query="SELECT*FROM allin WHERE categories='Men' AND brand='$brand' ";
                  $result=$db->select($query);
            ...
            <?php } else{?>
             ...
             <li> <a class="btn" href="?page=<?php echo$page+1 ?> & men=<?php echo$brand ?>">Next</a></li>
              <?php } }?>
              ...
              <div class="layered-Category">
                ...
                <div class="layered-content">
                           <ul class="check-box-list">
                            <?php 
                               $query="SELECT DISTINCT brand FROM allin WHERE categories='men'";
                               $resultab=$db->select($query);
                               while($rowab=$resultab->fetch_assoc()){
                            ?>
                      <li>
                      
                      <label for="jtv1"> <span class="button"></span> <a href="?men=<?php echo$rowab['brand'] ?>"><?php
                       $ibrand=$rowab['brand'];
                       echo$rowab['brand'] ?></a> <span class="count">(
                         <?php $query="SELECT*FROM allin WHERE categories='men' AND brand='$ibrand' ";
                               $result=$db->select($query);
                               $count=mysqli_num_rows($result);
                               echo $count;
                          ?>
          ...
          <div class="block compare">
            <div class="sidebar-bar-title">
             ...
             $query="SELECT*FROM compare WHERE email='$email' AND categories='Men' ";
               $result=$db->select($query);
               $count=mysqli_num_rows($result);
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                <?php 
                $query="SELECT*FROM allin WHERE categories='Men' AND type='Special' AND brand='$brand' ";
                 $result=$db->select($query);
                 if($result){
                  while($row=$result->fetch_assoc()){
                 ?>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
              ...
              <ul class="products-list" id="products-list">
                <?php 
                   ...
                   $select=$_POST['select'];
                     ...
                     if($select=='ASC'){
                    $query="SELECT*FROM allin WHERE categories='Men'  ORDER BY amount ASC  ";
                    $result=$db->select($query);
                  }
                  else{
                    $query="SELECT*FROM allin WHERE categories='Men' ORDER BY amount DESC  ";
                           $result=$db->select($query);
              ...
              <?php }else{?>
                 <?php 
                   if(!isset($_GET['page'])){
                    ...
                    $query="SELECT*FROM allin WHERE categories='Men' LIMIT $start,12 ";
                    $result=$db->select($query);
                    if($result){
                       while($row=$result->fetch_assoc()){
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                <?php 
                $query="SELECT*FROM allin WHERE categories='Men' AND type='Special' ";
                 $result=$db->select($query);
                 if($result){
                  while($row=$result->fetch_assoc()){
                 ?>
