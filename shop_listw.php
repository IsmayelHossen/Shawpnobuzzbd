      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class=""> <a title="Go to Home Page" href="shop_listw.php">Women</a><span>&raquo;</span></li>
            <li><strong><a title="Go to Home Page" href="shop_listw.php?women=$brand"><?php echo$brand ?> </a></strong></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            ...
            if($page>1){
              ...
              <li>  <a class="btn" href="?page=<?php echo$page-1 ?> & women=<?php echo$brand ?>">Previous</a></li>
               <?php }?>
            ...
            <?php } else{?>
             ...
             <li> <a class="btn" href="?page=<?php echo$page+1 ?> & women=<?php echo$brand ?>">Next</a></li>
              <?php } }?>
