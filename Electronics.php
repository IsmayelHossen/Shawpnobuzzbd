          ...
          <div class="block sidebar-cart">
            <div class="sidebar-bar-title">
             ...
             $query="SELECT*FROM cart WHERE email='$email' AND date2='$date1' AND NOT order1=1";
              ...
              ?>
            <div class="block-content">
              <p class="amount">There are <a href="shopping_cart.html"><?php echo$count; ?> items</a> in your cart.</p>
              <ul>
                               <?php 
                             $sum=0;
               while($row=$result->fetch_assoc()){
                    ...
                    <div class="item-inner">
                     ...
                     <?php
                        ...
                        <div class="box-hover">
                          <div class="product-item-actions">
                            <div class="pro-actions">
                              <button onclick="location.href='shopping_cart.html?pid=<?php echo $row["pid"]; ?>'" class="action add-to-cart" type="button" title="Add to Cart"> <span>Add to Cart</span> </button>
                            </div>
