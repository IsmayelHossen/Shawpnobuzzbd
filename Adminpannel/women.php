         ...
         <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <option value="Women">Women</option></select>
                        ...
                        <option value="Clothing">Clothing</option>
                         ...
                         <option value="Jewellarey">Jewellarey</option>
                        ...
                        <option value="T-Shirt">T-Shirt</option>
                         ...
                         <option value="Neaklace">Necklace</option>
                          <option value="Fingure Ring">Fingure Ring</option>
                          <option value="Ear Ring">Ear Ring</option>
                          <option value="Bracelet">Bracelet</option>
                           <option value="Jumka">Jumka</option>
